...
@section('content')
    ...
    <form action="/addActivity" method="POST">
        ...
        <textarea name="description" id="description" rows="6" maxlength="500" class="form-control" required></textarea>
        <br>
        </div>
        <div class="col-lg-4">
        ...
        <input type="number" name="minParticipants" id="minParticipants" min="1" max="1000" class="form-control" required> 
        <br>
        </div>
        <div class="col-lg-4">
        <label for="maxParticipants">Maximum participants <span style="color: red;">*</span></label><br>
        <input type="number" name="maxParticipants" id="maxParticipants" min="1" max="1000" class="form-control" required>
        <br>
        </div>
