...
@section('content')
    ...
    <form action="/editActivity/{{ $activity->id }}/update" method="POST">
        ...
        <div class="col-lg-4">
            ...
            <input type="text" name="name" id="name" maxlength="20" class="form-control" value="{{$activity->name}}"
                   required>
            <br>
        </div>
        <div class="col-lg-4">
        ...
        <div class="col-lg-4">
            ...
            <input type="text" name="image" id="image" maxlength="50" class="form-control" value="{{$activity->image}}"
                   required>
            <br>
        </div>
        <div class="col-lg-2">
            <label for="price">Price <span style="color: red;">*</span></label><br>
            <input type="number" name="price" id="price" min="1" max="10000" class="form-control"
                   value="{{$activity->price}}" required>
            <br>
        </div>
        <div class="col-lg-4">
            <label for="needs">Needs <span style="color: red;">*</span></label><br>
            <input type="text" name="needs" id="needs" maxlength="200" class="form-control" value="{{$activity->needs}}"
                   required>
            <br>
        </div>
        <div class="col-lg-4">
            <label for="location">Location <span style="color: red;">*</span></label><br>
            <input type="text" name="location" id="location" maxlength="20" class="form-control"
        ...
        <div class="col-lg-2">
            ...
            <input type="number" name="minParticipants" id="minParticipants" min="1" max="10000" class="form-control"
                   value="{{$activity->minParticipants}}" required>
            <br>
        </div>
        <div class="col-lg-2">
            <label for="maxParticipants">Max. Participants <span style="color: red;">*</span></label><br>
            <input type="number" name="maxParticipants" id="maxParticipants" min="1" max="10000" class="form-control"
                   value="{{$activity->maxParticipants}}" required>
            <br>
        </div>
        <div class="col-lg-2">
        ...
        <div class="col-lg-2">
            ...
            <input type="datetime-local" name="endTime" id="endTime" class="form-control" value="{{$activity->endTime}}"
                   required>
            <br>
        </div>
        <div class="col-lg-2">
