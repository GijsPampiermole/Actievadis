    ...
    <div class="accordion">
        ...
        <div class="content" id="accordion-content" style="max-height: 0px;">
            ...
            <div class="box">
                ...
                <div class="participants">{{ $activity->minParticipants }} - {{ $activity->maxParticipants }} Deelnemers</div>
